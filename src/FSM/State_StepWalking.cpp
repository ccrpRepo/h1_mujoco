...
void State_StepWalking::run()
{
    ...
    _tau.block(11, 0, 8, 1).setZero();
    // if((*_contact)(0) == 0)
    // {
    //     std::cout << _tau.block(0, 0, 5, 1).transpose() << std::endl;
    // }
    // if ((*_contact)(1) == 0)
    // {
